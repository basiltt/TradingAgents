...
def test_migration_versions_contiguous_and_unique():
    ...
    # MCP tables were renumbered from the branch's v43–v46 to v52–v55 during the
    # merge (Regime Multi-Strategy owns v43–v51, applied to the live DB first).
    # v52 is the callable that creates the 6 mcp_ tables; v53 is the string
    # backtest_runs ALTER.
