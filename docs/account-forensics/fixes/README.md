...
| [FIX-005](FIX-005-short-bounce-signal-guard.md) | Structured signal shorts oversold/bounce-prone coins; counter-trend + falling-knife shorts lose. Shipped as a deterministic filter + tight-geometry "Best Winrate" preset (backtest + live); live gate interval bug fixed | High (signal quality) | **fixed** | Unni | system-wide (all accounts) |
