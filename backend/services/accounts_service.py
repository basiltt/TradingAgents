...
class AccountsService:
    ...
    async def get_hf_snapshots(self, account_id: str, since_ts: str) -> List[Dict[str, Any]]:
    ...
    async def compute_hf_analytics(self, account_id: str, since_ts: str) -> Dict[str, Any]:
