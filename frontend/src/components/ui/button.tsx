  ...
  "group/button inline-flex shrink-0 items-center justify-center rounded-[calc(var(--radius)*1.2)] border text-sm font-medium whitespace-nowrap shadow-[var(--shadow-soft)] outline-none select-none focus-visible:border-ring focus-visible:ring-4 focus-visible:ring-ring/20 active:scale-[0.98] disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none aria-invalid:border-destructive aria-invalid:ring-4 aria-invalid:ring-destructive/15 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      ...
      size: {
        ...
        xs: "h-7 gap-1 rounded-[calc(var(--radius)*1.02)] px-2.5 text-[0.72rem] has-data-[icon=inline-end]:pr-2 has-data-[icon=inline-start]:pl-2 [&_svg:not([class*='size-'])]:size-3.5",
        sm: "h-8 gap-1.5 rounded-[calc(var(--radius)*1.06)] px-3 text-[0.78rem] has-data-[icon=inline-end]:pr-2.5 has-data-[icon=inline-start]:pl-2.5 [&_svg:not([class*='size-'])]:size-3.5",
        lg: "h-10 gap-2 px-4.5 text-sm has-data-[icon=inline-end]:pr-3.5 has-data-[icon=inline-start]:pl-3.5",
        icon: "size-9",
        "icon-xs":
          "size-7 rounded-[calc(var(--radius)*1.02)] [&_svg:not([class*='size-'])]:size-3.5",
        "icon-sm":
          "size-8 rounded-[calc(var(--radius)*1.06)]",
        "icon-lg": "size-10",
      },
    },
    defaultVariants: {
