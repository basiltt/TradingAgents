...
WRITABLE_KEYS: dict[str, list[str]] = {
    ...
    "research_manager": ["investment_plan", "investment_debate_state"],
    "trader": ["trader_investment_plan", "_trader_signal_data"],
    "compliance_officer": ["compliance_result", "_compliance_verdict"],
